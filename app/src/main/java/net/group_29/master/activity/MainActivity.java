...
import net.group_29.master.frontend.NewFileDialog;
...
import net.group_29.opoc.frontend.filebrowser.GsFileBrowserFragment;
import net.group_29.opoc.frontend.filebrowser.GsFileBrowserListAdapter;
...
public class MainActivity extends MarkorBaseActivity implements GsFileBrowserFragment.FilesystemFragmentOptionsListener, NavigationBarView.OnItemSelectedListener {
    ...
    public String getPosTitle(final int pos) {
        ...
        if (pos == 3) return getString(R.string.Templates);
        return "";
    }
